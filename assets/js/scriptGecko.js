...
function makeCard() {
  ...
  cardEl.innerHTML =
    "<div class='w3-container'><h3></h3><button class='star-btn w3-button w3-circle w3-teal w3-margin-bottom w3-right'></button><button class='trash'></button></div> <div class='w3-container'><p></p><a></a></div> <footer class='w3-container custom2'><h5></h5><h6></h6></footer>";
  apiEl.append(cardEl);
